...
message3 = tk.Label(window, text="Automated Attendence Management using Face Recognition" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
lbl = tk.Label(frame2, text="Enter VH No.",width=20  ,height=1  ,fg="black"  ,bg="#c79cff" ,font=('comic', 17, ' bold ') )
lbl.place(x=80, y=55)
...
if exists:
    ...
    res = 0
message.configure(text='Total Registrations Done : '+str(res))
